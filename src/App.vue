  ...
  <div id="main" :class="isDay ? 'day' : 'night'">
    <div class="container my-5" style="max-width: 400px; min-width: 360px">
      ...
      <form class="search-location" v-on:submit.prevent="getWeather">
        ...
        <div class="container d-flex flex-column justify-content-center mt-5" v-if="isLoading"   >
          <div class="row text-center mb-5" >
            <div class="col-12 text-primary " >
              <h2 style="font-weight: 800">Loading.....</h2>
            </div>
          </div>
          <div class="row mt-5" >
            <div class="col">
...
<script>
import { axiosInstance } from "../src/api/interceptor.js";
export default {
  data() {
    return {
      isLoading : false,
